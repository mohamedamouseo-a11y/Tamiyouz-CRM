...
import { Bell, Check, CheckCheck, Calendar, UserPlus, AlertTriangle, ArrowRightLeft, AtSign, Info, X } from "lucide-react";
...
export default function NotificationCenter({ isRTL, primaryColor }: Props) {
  ...
  const { data: notifications = [], refetch } = trpc.inAppNotifications.list.useQuery(
    { limit: 30 },
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div
          className={cn(
            "absolute top-full mt-2 w-[380px] max-h-[480px] bg-card border border-border rounded-xl shadow-xl z-50 flex flex-col overflow-hidden",
